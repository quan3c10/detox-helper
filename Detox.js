  ...
  _detectLocator(locator, type = 'type') {
    ...
    if (typeof locator === 'object') {
      ...
      for(var key in locator) {
        switch (key){
          case 'android':
            located = this._detectLocator(locator.android, type);
            break;
          case 'ios':
            located = this._detectLocator(locator.ios, type);
            break;
          case 'and':
            located = located.and(this._byObject(locator.and));
            break;
          case 'ancestor':
            located = located.withAncestor(this._byObject(locator.ancestor));
            break;
          case 'descendant':
            located = located.withDescendant(this._byObject(locator.descendant));
            break;
          default:
            located = this._byObject(locator);
        }
      }
